...
async def help_slash(interaction: discord.Interaction):
    ...
    embed.add_field(name="/stats", value="See your Valhalla Warrior stats.", inline=False)
    await interaction.response.send_message(embed=embed, ephemeral=True)
